...
| WebApp    | Components deployed to nodes with the `nxpod.khulnasoft.com/workload_meta` label.                                                                                                   |
| IDE       | Components deployed to nodes with the `nxpod.khulnasoft.com/workload_ide` label.                                                                                                    |
| Workspace | Components deployed to nodes with the `nxpod.khulnasoft.com/workload_workspace_headless`, `nxpod.khulnasoft.com/workload_workspace_regular` or `nxpod.khulnasoft.com/workload_services` labels. |
