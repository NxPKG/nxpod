...
Or, [open a Nxpod workspace](https://nxpod.khulnasoft.com/from-referrer/)
...
Releases can be downloaded from [GitHub Releases](https://github.com/nxpkg/nxpod/releases/)
Select your desired binary, download and install

1. Download the latest release with the command:

```shell
curl -fsSLO https://github.com/nxpkg/nxpod/releases/latest/download/nxpod-installer-linux-amd64
```
...
```shell
curl -fsSLO https://github.com/nxpkg/nxpod/releases/latest/download/nxpod-installer-linux-amd64.sha256
```
...
OpenVSX proxy (see [#8529](https://github.com/nxpkg/nxpod/issues/8529)).
...
- `nxpod.khulnasoft.com/workload_meta`
- `nxpod.khulnasoft.com/workload_ide`
- `nxpod.khulnasoft.com/workload_services`
- `nxpod.khulnasoft.com/workload_workspace_regular`
- `nxpod.khulnasoft.com/workload_workspace_headless`
