...
Or, [open a Nxpod workspace](https://gitpod.io/from-referrer/)
...
```shell
curl -fsSLO https://github.com/nxpkg/nxpod/releases/latest/download/gitpod-installer-linux-amd64
```
...
```shell
curl -fsSLO https://github.com/nxpkg/nxpod/releases/latest/download/gitpod-installer-linux-amd64.sha256
```
