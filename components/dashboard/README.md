...
## How to develop in nxpod.khulnasoft.com
...
Set the following 2 [environment variables](https://www.nxpod.khulnasoft.com/docs/environment-variables) either [via your account settings](https://nxpod.khulnasoft.com/variables) or [via the command line](https://www.nxpod.khulnasoft.com/docs/environment-variables#using-the-command-line-gp-env).
...
```bash
# Use "nxpod.khulnasoft.com" for the SaaS version of Nxpod, or specify the host of your self-hosted nxpod
GP_DEV_HOST=nxpod.khulnasoft.com
