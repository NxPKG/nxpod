 ...
 * This is used by "nxpod.io" and "www.nxpod.io" to display different content/buttons.
 */
...
export function options(domain: string): cookie.CookieSerializeOptions {
    ...
    return {
        ...
        domain: `.${domain}`, // explicitly include subdomains to not only cover "nxpod.io", but also "www.nxpod.io" or workspaces
    };
}
