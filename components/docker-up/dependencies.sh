...
curl -o docker-compose  -fsSL "https://github.com/nxpkg/compose/releases/download/v${DOCKER_COMPOSE_VERSION}/docker-compose-linux-x86_64"
curl -o checksums.txt  -fsSL "https://github.com/nxpkg/compose/releases/download/v${DOCKER_COMPOSE_VERSION}/checksums.txt"
