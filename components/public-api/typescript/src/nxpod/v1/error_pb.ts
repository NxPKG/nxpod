...
export class FailedPreconditionDetails extends Message<FailedPreconditionDetails> {
  ...
  reason: {
    ...
    /**
     * @generated from field: gitpod.v1.InvalidNxpodYMLError invalid_gitpod_yml = 4;
     */
  ...
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    ...
    { no: 4, name: "invalid_gitpod_yml", kind: "message", T: InvalidNxpodYMLError, oneof: "reason" },
...
/**
 * @generated from message gitpod.v1.InvalidNxpodYMLError
 */
export class InvalidNxpodYMLError extends Message<InvalidNxpodYMLError> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "gitpod.v1.InvalidNxpodYMLError";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
