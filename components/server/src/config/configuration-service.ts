...
# Please adjust to your needs (see https://www.nxpod.io/docs/introduction/learn-nxpod/nxpod-yaml)
# and commit this file to your remote git repository to share the goodness with others.

# Learn more from ready-to-use templates: https://www.nxpod.io/docs/introduction/getting-started/quickstart
