...
export class ExampleRepositories1612448906950 implements MigrationInterface {
    public async up(queryRunner: QueryRunner): Promise<any> {
        ...
        const newEntries = [
            {
                url: "https://github.com/nxpkg/sveltejs-template",
            ...
            {
                url: "https://github.com/nxpkg/ruby-on-rails",
                description: "**Ruby** – A Rails example with PostgreSQL database",
                priority: 30,
            },
            {
                url: "https://github.com/nxpkg/dotnetcore",
