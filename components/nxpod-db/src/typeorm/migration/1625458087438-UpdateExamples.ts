...
export class UpdateExamples1625458087438 implements MigrationInterface {
    public async up(queryRunner: QueryRunner): Promise<any> {
        ...
        const newEntries = [
            {
                url: "https://github.com/nxpkg/template-typescript-node",
                description: "A Node.js app, written in TypeScript.",
                priority: priority--,
            },
            {
                url: "https://github.com/nxpkg/template-typescript-react",
                description: "A create-react-app template, written in TypeScript.",
                priority: priority--,
            },
            {
                url: "https://github.com/nxpkg/template-python-django",
                description: "A Django app template. ",
                priority: priority--,
            },
            {
                url: "https://github.com/nxpkg/template-python-flask",
                description: "A Flasker app template.",
                priority: priority--,
            },
            {
                url: "https://github.com/nxpkg/spring-petclinic",
                description: "A Spring app written in Java.",
                priority: priority--,
            },
            {
                url: "https://github.com/nxpkg/template-php-drupal-ddev",
                description: "A Drupal app template, scaffolded by DDEV.",
                priority: priority--,
            },
            {
                url: "https://github.com/nxpkg/template-php-laravel-mysql",
                description: "A Laravel app template, with MySQL.",
                priority: priority--,
            },
            {
                url: "https://github.com/nxpkg/template-ruby-on-rails",
                description: "A Ruby on Rails app template, with Postgres. ",
                priority: priority--,
            },
            {
                url: "https://github.com/nxpkg/template-golang-cli",
                description: "A CLI template, written in Go.",
                priority: priority--,
            },
            {
                url: "https://github.com/nxpkg/template-rust-cli",
                description: "A CLI template, written in Rust.",
                priority: priority--,
            },
            {
                url: "https://github.com/nxpkg/template-dotnet-core-cli-csharp",
                description: "A CLI starter for .NET written in C#.",
                priority: priority--,
            },
            {
                url: "https://github.com/nxpkg/template-sveltejs",
                description: "A Svelte.js app writtten in JavaScript.",
                priority: priority--,
            },
            {
                url: "https://github.com/nxpkg/template-sveltejskit",
                description: "A SvelteKit app template.",
                priority: priority--,
            },
            {
                url: "https://github.com/nxpkg/template-datasette",
                description: "A Datasette template.",
                priority: priority--,
            },
            {
                url: "https://github.com/nxpkg/template-nix",
                description: "A nix template for reproducible development environments.",
                priority: priority--,
            },
            {
                url: "https://github.com/nxpkg/template-haskell",
