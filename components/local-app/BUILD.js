    ...
    let pkg = {
        ...
        config: {
            ...
            buildCommand: [
                ...
                `GOARCH=${goarch} go build -trimpath -ldflags "-X github.com/nxpkg/local-app/pkg/constants.GitCommit=\${__git_commit} -X github.com/nxpkg/local-app/pkg/constants.BuildTime=\$(date +%s)" -o ${binaryName} ${mainFile}`,
            ],
        },
        binaryName,
    };
