module github.com/nxpkg/nxpod/workspacekit

go 1.22

replace github.com/seccomp/libseccomp-golang => github.com/nxpkg/libseccomp-golang v0.9.2-0.20220701021458-9bf1c833815b
