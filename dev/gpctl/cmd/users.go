...
func init() {
	...
	usersCmd.PersistentFlags().StringVar(&usersCmdOpts.address, "address", "wss://nxpod.khulnasoft.com/api/v1", "Address of the API endpoint. Must be in the form <host>:<port>.")
